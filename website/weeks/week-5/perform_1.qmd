...
sustainable_pct <- round(adoption_summary$pct[adoption_summary$practice_category == "Sustainable Practices"], 1)
burning_pct <- round(adoption_summary$pct[adoption_summary$practice_category == "Complete Burning"], 1)

cat("The dataset shows that **", sustainable_pct, "%** of farmers have adopted sustainable practices, while **", burning_pct, "%** still engage in complete burning.", sep = "")
```
:::
