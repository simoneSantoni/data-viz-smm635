...
opportunity. The data, in Excel format, are available in the [data 
directory](https://github.com/simoneSantoni/data-viz-smm635/tree/master/data) 
of SMM635's GitHub repository (see file `real_estate.xlsx`).
